...
extern volatile uint16_t     g_search_first_min_strafe_mm;
extern volatile uint16_t     g_search_cycle_min_strafe_mm;
extern volatile uint16_t     g_vision_burst_need_count;
extern volatile uint16_t     g_vision_burst_window_ms;
