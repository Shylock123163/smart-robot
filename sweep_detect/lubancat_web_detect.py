...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LubanCat web realtime clutter classification")
    parser.add_argument("--weights", required=True, help="path to best.pt")
    parser.add_argument("--camera", type=int, default=0, help="camera index")
    parser.add_argument("--port", type=int, default=5005, help="web port")
    ...
    while True:
        try:
            ...
            while True:
                ...
                results = model.predict(source=roi_frame, imgsz=args.imgsz, device=args.device, verbose=False)
        ...
        <head>
            ...
            <script>
                ...
                async function refreshStatus() {
                    ...
                    document.getElementById('tip').textContent = '鲁班猫端实时检测，推理前先裁剪 ROI';
