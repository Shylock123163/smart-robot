      ...
      <main className="about-main">
        ...
        <section className="about-section">
          ...
          <p>
            ...
            网页作为 OpenClaw 的上层任务中枢，承担任务输入、决策解释、状态可视化与调试功能。
          </p>
          <p>
            OpenClaw 不直接控制电机，而是负责高层任务理解、操作策略生成、任务阶段切换、动作原因解释和多轮交互记忆。
        ...
        <section className="about-section">
          <h2>系统架构</h2>
          <p>用户网页输入任务 → OpenClaw 理解任务 → 生成执行策略 → 上位机拆解步骤 → STM32 执行动作 → 网页实时显示状态与结果</p>
        </section>
